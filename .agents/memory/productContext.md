...
- **Goal 4:** Reach v0.1.0 with all MiniPRDs implemented (all pipeline MiniPRDs complete as of v0.0.9; remaining: WorkspaceInit, StateGraph, Orchestrator, AuditState, ArchiveManager).
