...
- When the user explicitly runs `/session-update`.
...
2. **Update Product & Design Specs**
   ...
   - **CRITICAL:** Do NOT manually modify `spec/compiled/architecture.yml`. Use the deterministic scripts or `/discover`/`/audit` for that.
